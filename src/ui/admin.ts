    ...
    <main>
      ...
      <section class="panel publisher-panel" id="publishing">
        ...
        <div class="publisher-grid">
          ...
          <article class="publisher-card"><span class="publisher-step">2</span><h3>Copy the closure</h3><p>Use the normal Nix command for ordinary uploads. For NARs above the Worker request limit, use the direct-upload API described in the deployment guide.</p><pre class="publisher-code">nix copy --to ${origin} ./result</pre></article>
